...
class DoodleJump:
    ...
    def drawPlatforms(self):
        ...
        for p in self.platforms:
            ...
            if next_y > ScreenSize[1]:
                ### add a new platform
                x = random.randint(0,800-self.size_platform[0])
                platform_type = 0
    ...
    def drawBackground(self):
        ...
        ### draw grids
        for i in range(ScreenSize[0]//14+1): pygame.draw.line(self.screen,ColorKhaki,(i*14,0),(i*14,600),1)
        for i in range(ScreenSize[1]//14+1): pygame.draw.line(self.screen,ColorKhaki,(0,i*14),(800,i*14),1)
    ...
    def startmenu(self): 
        ...
        while True:
            ...
            words1 = self.font.render('Press Space to play.',True,ColorBlack)
            self.screen.blit(words1,(150,170))
            words2 = self.font.render('Press ESC to leave.',True, ColorBlack)
            self.screen.blit(words2,(150,230))
            words3 = self.font.render('Press h to see your highest score.', True,ColorBlack)
            self.screen.blit(words3,(150,290))
            pygame.display.flip()
            while True:
